...
function tambah($data)
{
	...
	// query insert data
	$query = "INSERT INTO mahasiswa(idMhs,nim,nama,jenisKelamin,tempatLahir,tglLahir,alamat,email,fakultas)
				VALUES
...
{
	global $conn;
	mysqli_query($conn, "DELETE FROM mahasiswa WHERE idMhs = $id");
