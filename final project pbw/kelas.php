                    ...
                    <div class="container-fluid">
                        ...
                        <?php if($role == "2") { ?>
                            <div class="tambah mt-3 ml-4 px-4 ">
                                <a href="buatKls.php" class="btn btn-secondary">Buat Kelas Matakuliah</a>
                            </div>
                        <?php } ?>
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <?php while($data = mysqli_fetch_assoc($queryKelas)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if($role == "2") { ?> 
                                                        <td><a href="editKls.php?id_kelas=<?= $data['id_kelas']; ?>" class="badge badge-primary ">Edit</a> | <a href="function.php?act=hapusKelas&id_kelas=<?= $data['id_kelas']; ?>" onclick="return confirm('Yakin ingin menghapus kelas?');" class="badge badge-danger ">Hapus</a> | <a href="lihatKls.php?id_kelas=<?= $data['id_kelas']; ?>" class="badge badge-secondary ">Lihat</a> </td>
                                                    <?php } ?>
                                                    
                                                    <?php if($role == "1") { ?>
                                                        <td><a href="function.php?act=joinKelas&id_kelas=<?= $data['id_kelas']; ?>" class="badge badge-success ">Ikut Kelas</a> | <a href="lihatKls.php?id_kelas=<?= $data['id_kelas']; ?>" class="badge badge-secondary ">Lihat</a></td> 
                                                    <?php } ?> 
