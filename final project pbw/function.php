...
function joinKelas()
{
    ...
    $queryCek = mysqli_query($koneksi, "SELECT * FROM masuk_kelas WHERE id_kelas = '$idKelas'");
    $data = mysqli_fetch_assoc($queryCek);
    if($data['id_mahasiswa']==$mahasiswa){
        echo "<script>
        alert('Anda Sudah Bergabung ke Kelas Yang Dipilih!');
        document.location.href = 'lihatKls.php?id_kelas= $idKelas';
            </script>";
    } else{

    $queryKelas = "INSERT INTO masuk_kelas VALUES ('','$mahasiswa', '$idKelas')";
...
function editProfil($id_mahasiswa)
{
    ...
    $exe = mysqli_query($koneksi, $queryProfil);
        ...
        document.location.href = 'profilMhs.php';
            </script>";
}
...
function editDosen($id_dosen)
{
    ...
    $exe = mysqli_query($koneksi, $queryProfil);
        ...
        echo "<script>
        alert('Berhasil Update Profil!');
        document.location.href = 'profilDosen.php';
            </script>";
}
