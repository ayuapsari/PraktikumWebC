...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2020 at 09:11 PM
...
(4, '2', '1984082920181113001', '	082908840', 'I Wayan Supriana, S.Si., M.Cs.', 'wayan.supriana@unud.ac.id', 'jimbaran', '2020-05-29', 'aktif', '$2y$10$Qj53qMmFgz3VGE6ItG.umuQrLl5LjN.Ei9QTmEJpuygMHsUBVrYLO'),
(5, '2', '1985091920181113001', '0819098502', 'Made Agung Raharja, S.Si., M.Cs.', 'made.agung@unud.ac.id', 'jimbaran', '2020-05-29', 'aktif', '$2y$10$aWUI6gEIpzYx6oHxwQ6qsOiQaJ.ZCMPUYXPSwn7Efw8WnDPA9.bvu'),
(6, '2', '196401141994022001', '0014016403', 'Dra. Luh Gede Astuti,M.Kom.', 'lg.astuti@cs.unud.ac.id', 'jimbaran', '2020-05-29', 'aktif', '$2y$10$jiEYVuwaU2bEZHTgLujv/eE0FANYRu9gRBm43WMFnAc9wLH0u0XOC');
...
(1, 'Algoritma Pemrograman B', '12.00 - 14.50', 25, 4, 'aktif'),
(9, 'Kalkulus A', '13.00 - 14.00', 21, 5, 'aktif'),
(10, 'Pengolahan Data Digital A', '13.00 - 14.00', 21, 4, 'aktif');
...
(1, '1', '1708561053', 'Sherly Anggita', 'sherlyanggita@gmail.com', 'Jimbaran', '2020-05-14', 'aktif', '$2y$10$n/bNgl/F6z/XeTbsdA28G.LMADwFYHcCEm/la2STF56Sv.FssqlAi'),
(2, '1', '1708561085', 'Winda Rianty', 'windar@gmail.com', 'Jimbaran', '2020-04-28', 'aktif', '$2y$10$ePnwfLXkebClZ8zVxS1KQeRPmoHI4uNhBuX54gFlEQurEg4RJ67KC'),
(3, '1', '1708561082', 'Ni Made Sinta Wahyuni', 'sintawahyuni@gmail.com', 'Jimbaran', '2020-04-30', 'aktif', '$2y$10$3az3IMKARR8Fapub6neHZuB4rzmhdj9Ttu2V9wq4NtLx4g7lzPqRG'),
(4, '1', '1708561067', 'made sri ayu apsari', 'ayuapsaarii25@gmail.com', 'jimbaran', '1999-06-25', 'aktif', '$2y$10$AFO798zndH23Xk9G.LHvmOjrkmOFuSSgCXDH8lOQ/2orjH/izeemC'),
(5, '1', '1708561057', 'I Gusti Ayu Widiantari Putri', 'ayutari@gmail.com', 'jimbaran', '2020-05-29', 'aktif', '$2y$10$rm/AOLmY1p4UFWa8zsU4xuhxtCVulJ2NGude9igDX8eJKt4WOo3FC'),
(6, '1', '1708561071', 'Pingkan Anggriani Pitoy', 'pingkan28@gmail.com', 'jimbaran', '2020-05-29', 'aktif', '$2y$10$UfjuyyxY5WV0cArz6xW9qeoTSnjNqkrOFLw0HhD2xL4YUDV.WcIaC');
...
(4, 'IF1610', 'Bahasa Inggris', 2),
(5, 'IF1610', 'Kewarganegaraan', 2),
(6, 'IF1610', 'Kalkulus 1', 3),
(7, 'IF1610', 'Matematika Diskrit 1', 3);
